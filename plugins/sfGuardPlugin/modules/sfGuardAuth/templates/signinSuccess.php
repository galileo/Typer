...
<?php echo form_tag('@sf_guard_signin') ?>
  ...
  <?php 
  echo submit_tag(__('zaloguj')), 
  link_to(__('Zapomniałeś hasła?'), '@sf_guard_password', array('id' => 'sf_guard_auth_forgot_password')) 
  ?>
</form>
</div>
