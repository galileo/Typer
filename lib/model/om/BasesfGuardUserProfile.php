...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the pieniadze field.
	 * @var        int
	 */
	protected $pieniadze;
	...
	/**
	 * Get the [pieniadze] column value.
	 * 
	 * @return     int
	 */
	public function getPieniadze()
	{
	...
	public function setAktywny($v)
	{
		...
		if ($this->aktywny !== $v) {
			$this->aktywny = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::AKTYWNY;
		}
	...
	/**
	 * Set the value of [pieniadze] column.
	 * 
	 * @param      int $v new value
	 * @return     void
	 */
	public function setPieniadze($v)
	{
		...
		if ($this->pieniadze !== $v) {
			$this->pieniadze = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::PIENIADZE;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->aktywny = $rs->getInt($startcol + 5);

			$this->birthday = $rs->getDate($startcol + 6, null);

			$this->pieniadze = $rs->getInt($startcol + 7);
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getAktywny(),
			$keys[6] => $this->getBirthday(),
			$keys[7] => $this->getPieniadze(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setAktywny($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setBirthday($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setPieniadze($arr[$keys[7]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::AKTYWNY)) $criteria->add(sfGuardUserProfilePeer::AKTYWNY, $this->aktywny);
		if ($this->isColumnModified(sfGuardUserProfilePeer::BIRTHDAY)) $criteria->add(sfGuardUserProfilePeer::BIRTHDAY, $this->birthday);
		if ($this->isColumnModified(sfGuardUserProfilePeer::PIENIADZE)) $criteria->add(sfGuardUserProfilePeer::PIENIADZE, $this->pieniadze);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPieniadze($this->pieniadze);
