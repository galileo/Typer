...
abstract class BasesfGuardUserProfilePeer {
	...
	const AKTYWNY = 'sf_guard_user_profile.AKTYWNY';

	/** the column name for the BIRTHDAY field */
	const BIRTHDAY = 'sf_guard_user_profile.BIRTHDAY';

	/** the column name for the PIENIADZE field */
	const PIENIADZE = 'sf_guard_user_profile.PIENIADZE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'FirstName', 'LastName', 'Email', 'Aktywny', 'Birthday', 'Pieniadze', ),
		BasePeer::TYPE_COLNAME => array (sfGuardUserProfilePeer::ID, sfGuardUserProfilePeer::USER_ID, sfGuardUserProfilePeer::FIRST_NAME, sfGuardUserProfilePeer::LAST_NAME, sfGuardUserProfilePeer::EMAIL, sfGuardUserProfilePeer::AKTYWNY, sfGuardUserProfilePeer::BIRTHDAY, sfGuardUserProfilePeer::PIENIADZE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'first_name', 'last_name', 'email', 'aktywny', 'birthday', 'pieniadze', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'FirstName' => 2, 'LastName' => 3, 'Email' => 4, 'Aktywny' => 5, 'Birthday' => 6, 'Pieniadze' => 7, ),
		BasePeer::TYPE_COLNAME => array (sfGuardUserProfilePeer::ID => 0, sfGuardUserProfilePeer::USER_ID => 1, sfGuardUserProfilePeer::FIRST_NAME => 2, sfGuardUserProfilePeer::LAST_NAME => 3, sfGuardUserProfilePeer::EMAIL => 4, sfGuardUserProfilePeer::AKTYWNY => 5, sfGuardUserProfilePeer::BIRTHDAY => 6, sfGuardUserProfilePeer::PIENIADZE => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'first_name' => 2, 'last_name' => 3, 'email' => 4, 'aktywny' => 5, 'birthday' => 6, 'pieniadze' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::AKTYWNY);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::BIRTHDAY);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::PIENIADZE);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addsfGuardUserProfile($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initsfGuardUserProfiles();
				$obj2->addsfGuardUserProfile($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(sfGuardUserProfilePeer::ID); // remove pkey col since this table uses auto-increment
