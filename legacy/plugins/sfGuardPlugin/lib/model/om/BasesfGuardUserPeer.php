...
abstract class BasesfGuardUserPeer {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lib/model/Komentarze.php';

			// delete related Komentarze objects
			$c = new Criteria();
			
			$c->add(KomentarzePeer::USER_ID, $obj->getId());
			$affectedRows += KomentarzePeer::doDelete($c, $con);

			include_once 'lib/model/Typ.php';

			// delete related Typ objects
			$c = new Criteria();
			
			$c->add(TypPeer::USER_ID, $obj->getId());
			$affectedRows += TypPeer::doDelete($c, $con);

			include_once 'lib/model/Punkty.php';

			// delete related Punkty objects
			$c = new Criteria();
			
			$c->add(PunktyPeer::USER_ID, $obj->getId());
			$affectedRows += PunktyPeer::doDelete($c, $con);
